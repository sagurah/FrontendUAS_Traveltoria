            ...
            <v-card width="600" class="mx-auto px-3 rounded-b-xl mt-4" elevation="3" color="teal lighten-5">
                ...
                <v-container class="mt-3">
                    <v-form ref="form">
                        ...
                        <v-row class="mt-0">
                            <v-col>
                                <v-text-field required outlined v-model="form.tanggal" readonly @click="dialogDate = true" color="teal" label="Tanggal" prepend-inner-icon="mdi-calendar"></v-text-field>
                            </v-col>
                            <v-col>
                ...
                <v-dialog v-model="dialogShow" width="450">
                    <v-card elevation="3" style="border-radius: 5px;">
                        <v-card-title>
                            <span class="mx-auto my-1">List Pesawat</span>
                        </v-card-title>
                        <v-divider></v-divider>
                        <v-card-content>
